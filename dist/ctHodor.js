...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: {
    place: {
      default: 'left',
      validator: function validator(value) {
        return ['left', 'right', 'top', 'bottom', 'top-right', 'top-left'].indexOf(value) > -1;
      }
    },
    trigger: {
      default: 'hover',
